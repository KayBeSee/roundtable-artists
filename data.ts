...
export const data: DataConfig = {
  ...
  artists: {
    ...
    ["the-kind-thieves"]: {
      ...
      bio: [
        `Emerging from the scenic landscapes of Southern West Virginia, The Kind Thieves are a captivating jam band that sets the stage ablaze with their awe-inspiring live performances. This musical collective comprises extraordinary talents hailing from various corners of the region, blending a tapestry of influences ranging from classic rock to funk and bluegrass. Their unique fusion of genres, wrapped in the ethereal embrace of jam-band magic, ensures an electrifying and 100% original experience each time they take the stage.`,
        `Attempting to pigeonhole The Kind Thieves within the confines of a single genre would be an exercise in futility. Their music transcends boundaries, resonating with heart-wrenching melodies, breathtaking harmonies, and songwriting prowess that belies their years. The band fearlessly explores uncharted musical territories, leaving no stone unturned and consistently defying expectations.`,
        `In 2017, The Kind Thieves unveiled their full-length debut record, 'Many A Thief,' instantly captivating audiences and amassing a growing legion of devoted fans. The album's unforgettable hooks and enchanting storytelling sensibilities cemented their place in the hearts of listeners. Not content to rest on their laurels, the band ventured further into unexplored sonic landscapes with their sophomore release, 'The Shape.' This album garnered critical acclaim and introduced the world to the band's mesmerizing single, "Fire & Flood".`,
        `When The Kind Thieves take the stage, audiences are transported to a realm where time slows down, and music becomes an immersive journey. Their mastery of improvisation and their uncanny ability to channel the collective energy of both band and crowd create an atmosphere that is nothing short of extraordinary. The stage becomes a living, breathing entity, pulsating with the shared euphoria of performers and fans alike.`,
        `Prepare to be spellbound as The Kind Thieves weaves their musical tapestry, casting a sonic spell that enchants and captivates all who are fortunate enough to witness their live show. With each performance, they redefine what it means to be a jam band, leaving audiences in a state of blissful wonder, eager to embark on the next adventure these musical maestros have in store.`,
        `At the core of The Kind Thieves are five exceptional musicians, each bringing their own unique talents and creative spirit to the ensemble. John Colby Elswick, a master of the guitar, possesses a soulful voice that weaves intricate melodies, while his songwriting prowess evokes profound emotions. Archibald Johnson, another gifted guitarist and vocalist, adds his own distinctive flair to the mix, infusing his original songwriting with raw energy and infectious enthusiasm. Drew Shinhearts, the band's bassist, not only holds down the rhythm with precision but also contributes his composition input as well as captivating vocals, adding depth and richness to the band's sonic landscape. Ben James, a skilled percussionist and drummer, drives the band's infectious grooves and rhythmic explorations, creating a solid foundation for their musical odyssey. Lastly, Christian Tanzey, a virtuoso on the keyboard and trumpet, adds layers of texture and melodic brilliance to the band's soundscapes, elevating their performances to breathtaking heights. Together, these five individuals form a musical brotherhood that is The Kind Thieves, a force to be reckoned with and a testament to the boundless possibilities of musical collaboration.`,
      ],
      social: {
